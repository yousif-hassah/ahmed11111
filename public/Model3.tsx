...
const ModelViewer: FC<ViewerProps> = ({
  ...
  width = 400,
  height = 400,
  // === الإعدادات المعدلة لزاوية الرؤية ===
  modelXOffset = 0, // إبقاء النموذج في المنتصف الأفقي
  modelYOffset = 0.2, // تعديل بسيط لأسفل (بدلاً من 1) لجعله أقرب لمركز الصورة
  defaultRotationX = -12, // ميل طفيف جداً للأسفل، مما يعطي إحساساً بالنظر من مستوى العين أو أعلى قليلاً
  defaultRotationY = 45, // زاوية جانبية جيدة لمشاهدة مقدمة وجانب السيارة
  defaultZoom = 1.2, // تكبير أكثر قليلاً لملء الشاشة بالسيارة
  // ======================================
  minZoomDistance = 0.5,
  maxZoomDistance = 10,
  ...
  ambientIntensity = 0.5, // زيادة طفيفة للإضاءة المحيطة لتفتيح السيارة بشكل عام
  keyLightIntensity = 1,
  fillLightIntensity = 0.7, // زيادة إضاءة التعبئة لتخفيف الظلال قليلاً
  rimLightIntensity = 0.8,
  environmentPreset = "none", // تم التغيير إلى "none" لخلفية رمادية بسيطة كما في الصورة
  autoFrame = false,
  placeholderSrc,
  ...
  return (
    ...
    >
      ...
      >
        {/* تم تغيير البيئة إلى "none" لجعل الخلفية رمادية بسيطة */}
        {environmentPreset !== "none" && (
          <Environment preset={environmentPreset as any} background={false} />
        )}
        {/* في حالة environmentPreset = "none"، يمكنك إضافة لون خلفية يدويًا للـ Canvas إذا لزم الأمر */}
        {environmentPreset === "none" && <color attach="background" args={['#808080']} />} 
