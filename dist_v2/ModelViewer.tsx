...
const ModelViewer: FC<ViewerProps> = ({
  ...
  modelYOffset = 0.5, // تعديل بسيط لأسفل (بدلاً من 1) لجعله أقرب لمركز الصورة
  defaultRotationX = -5, // ميل طفيف جداً للأسفل، مما يعطي إحساساً بالنظر من مستوى العين أو أعلى قليلاً
